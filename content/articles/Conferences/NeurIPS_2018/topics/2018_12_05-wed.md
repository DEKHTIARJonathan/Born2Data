...
**Link to paper:** <https://is.gd/variance_SGD>
<!-- https://is.gd/stats.php?url=variance_SGD -->
...
### 6. Tangent: Automatic differentiation using source-code transformation for dynamically typed array programming
...
**Link to paper:** <https://is.gd/local_hessian_backprop>
<!-- https://is.gd/stats.php?url=local_hessian_backprop -->
...
**TF Blog Post:** <https://is.gd/medium_NALU>
<!-- https://is.gd/stats.php?url=medium_NALU -->

Numerous third party blog posts are available on that one.

**Blog Post 1:** <https://is.gd/medium_NALU_2>
<!-- https://is.gd/stats.php?url=medium_NALU_2 -->

**Blog Post 2:** <https://is.gd/medium_NALU_3>
<!-- https://is.gd/stats.php?url=medium_NALU_3 -->
...
**Link to paper:** <https://is.gd/porcupine_NN>
<!-- https://is.gd/stats.php?url=porcupine_NN -->
...
**Unofficial Summary:** <https://is.gd/blog_1_adding_one_neuron>
<!-- https://is.gd/stats.php?url=blog_1_adding_one_neuron -->

**Unofficial blog post:** <https://is.gd/blog_2_adding_one_neuron>
<!-- https://is.gd/stats.php?url=blog_2_adding_one_neuron -->
...
**Blog Post (FR):** <https://is.gd/dim_reduction_imperfections>
<!-- https://is.gd/stats.php?url=dim_reduction_imperfections -->

----------------------

### 15. Deep Non-Blind Deconvolution via Generalized Low-Rank Approximation

**Link to paper:** <https://is.gd/deconv_low_rank>
<!-- https://is.gd/stats.php?url=deconv_low_rank -->

----------------------

### 16. A loss framework for calibrated anomaly detection

**Link to paper:** <https://is.gd/loss_framework_anomaly_detect>
<!-- https://is.gd/stats.php?url=loss_framework_anomaly_detect -->
...
**Link to paper:** <https://is.gd/scalable_laplacian_k_modes>
<!-- https://is.gd/stats.php?url=scalable_laplacian_k_modes -->
...
**Link to paper:** <https://is.gd/dim_reduction_pop_data>
<!-- https://is.gd/stats.php?url=dim_reduction_pop_data -->
